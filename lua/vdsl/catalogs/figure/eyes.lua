...
return Catalog.new {
  ...
  blue    = Trait.new("blue eyes")
    ...
    :tag(K.CONFLICTS, "blonde hair")
    :desc("blue eyes"),
  red     = Trait.new("red eyes")
    :confidence(0.95):tag(K.TIER, "S"):tag(K.SOURCE, "danbooru")
    :tag(K.CONFLICTS, "red hair")
    :desc("red eyes"),
  green   = Trait.new("green eyes")
    :confidence(0.95):tag(K.TIER, "S"):tag(K.SOURCE, "danbooru")
    :tag(K.CONFLICTS, "green hair")
    :desc("green eyes"),
  ...
  aqua    = Trait.new("aqua eyes")
    :confidence(0.80):tag(K.TIER, "A"):tag(K.SOURCE, "danbooru")
    :desc("aqua-colored eyes"),
  pink    = Trait.new("pink eyes")
    :confidence(0.80):tag(K.TIER, "A"):tag(K.SOURCE, "danbooru")
    :tag(K.CONFLICTS, "pink hair")
    :desc("pink eyes"),
  ...
  heterochromia = Trait.new("heterochromia", 1.2)
    ...
    :desc("heterochromia with each eye a different color"),
  ...
  slit_pupils = Trait.new("slit pupils")
    ...
    :desc("vertical slit pupils like a cat"),
  ...
  glowing = Trait.new("glowing eyes")
    ...
    :desc("eyes glowing with supernatural light"),
